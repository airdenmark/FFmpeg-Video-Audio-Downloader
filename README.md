...
* **Flexible Audio & Video Formats:**
  * **MP4 Video:** Full quality with auto-merged streams and embedded subtitles.
  * **M4A Audio:** Direct, native AAC audio stream extraction (zero quality loss).
  * **MP3 Audio:** High-quality VBR (Variable Bitrate) conversion via FFmpeg using the best available audio stream.
  * **Opus Audio:** Direct raw WebM stream extraction.
* **Advanced Subtitles:** Automatically downloads and embeds subtitles directly into MP4 video files.
...
| **Audio Extraction** | Often paywalled or low bitrate | **Native AAC, MP3 & Opus** |
| **Subtitle Files** | Often hardcoded or ignored | **Embedded directly into MP4** |
...
2. Download the `.zip` file (e.g., `FFmpeg.Video.Audio.Downloader.v1.2.1.zip`).
